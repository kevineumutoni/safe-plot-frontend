...
[![Backend API](https://img.shields.io/badge/Backend%20API-render.com-0F4C35?style=for-the-badge&logo=render)](https://safeplot-api.onrender.com)
...
![SafePlot Architecture](./docs/architecture.png)
...
> 📐 **[View Full Architecture Diagram →](./docs/SafePlot_Architecture.html)**
